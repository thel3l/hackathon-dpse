    ...
    */
    ...
    $.terminal = {
        ...
        test: function() {
            ...
            string = 'https://www.github.com/thel3l/hackathon-dpse';
            ...
            string = 'i.rithwiK@protonmail.com';
            ...
            string = '[[bui;#fff;]LELELELELELEELEL.';
    ...
    // -----------------------------------------------------------------------
    var version = '{{VER}}';
    var copyright = 'Coded with ❤ by thel3l, lunaroyster and rithvikvibhu.';
            ...
            */
            ...
            if (validate('prompt', settings.prompt)) {
                ...
                make_interpreter(init_interpreter, function(interpreter) {
                    ...
                    // CREATE COMMAND LINE
                    //Credits to http://terminal.jcubic.pl   . @arnav.
